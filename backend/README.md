...
## Project Structure
    ...
    ├── testapiautocatalog_115863  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115863`
...
2. Clone this repo and `cd testapiautocatalog_115863`
